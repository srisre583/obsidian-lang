...
from errors import IllegalCharError, ObsidianSyntaxError
...
class Lexer:
    ...
    def make_string(self):
        ...
        if self.current_char != '"':
            return None, ObsidianSyntaxError(
                pos_start, self.pos, "Expected closing '\"'"
            )
    ...
    def make_identifier(self):
        ...
        # Obsidian "shards" (keywords) vs plain identifiers
    ...
    def make_not_equals(self):
        ...
        self.advance()
        return None, ObsidianSyntaxError(pos_start, self.pos, "'=' expected after '!'")
